    ...
    <>
      <footer className="footer-container">
        <div className="footer-link-container">
          ...
          <div className="footer-social-icon">
            <ul>
              <li>
                <a
                  href="https://www.instagram.com/leftoverdinher/?hl=en"
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/laura-dinh-077a28160/"
                  className="navbar-content"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.youtube.com/@leftoverdinher"
                  className="navbar-content"
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        <div className="footer-content-container">
          <p className="footer-content">Made with 💖 by Laura Dinh</p>
          <div className="footer-social-icon">
            <ul>
              <li>
                <Link
